...
export default function About() {
  return (
    <section id="about" className="py-24 md:py-28 relative overflow-hidden" data-testid="section-about">
      ...
      <div className="absolute top-0 right-0 w-[500px] h-[500px] bg-blue-500/5 dark:bg-blue-500/8 rounded-full blur-[120px] pointer-events-none" />
            ...
            <div className="glass-card p-7 md:p-8 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-sm">
              ...
              <ul className="space-y-7">
                {[
                  ...
                  >
                    <div className="flex-shrink-0 w-11 h-11 rounded-xl bg-blue-50 dark:bg-blue-950/50 border border-blue-200 dark:border-blue-800/60 text-primary flex items-center justify-center font-bold text-base font-display">
                      {item.value}
                    </div>
                    <div>
