                ...
                >
                  ...
                  >
                    <div className="flex items-start justify-between gap-3 mb-1.5 flex-wrap">
                      ...
                      <span className="font-mono text-xs px-2 py-0.5 bg-muted rounded text-slate-500 shrink-0">{edu.period}</span>
                    </div>
                    <p className="text-sm text-muted-foreground mb-1.5">{edu.institution}</p>
              ...
              {certifications.map((cert, idx) => (
                ...
                >
                  <div className="flex items-start justify-between gap-3 mb-1.5 flex-wrap">
                    ...
                    <span className="font-mono text-xs px-2 py-0.5 bg-muted rounded text-slate-500 shrink-0">{cert.date}</span>
                  </div>
